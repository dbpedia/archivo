    ...
    if description != None:
        md_description = (
            md_description.safe_substitute(
                non_information_uri=uri,
                snapshot_url=snapshot_url,
                owl_version_iri=owl_version_iri,
...
def updateParentPoms(rootdir, index):
    ...
    for uri in index:
        ...
        artifactDirs = [
            dir
            for dir in os.listdir(os.path.join(rootdir, group))
            if os.path.isdir(os.path.join(rootdir, group, dir))
            and os.path.isfile(os.path.join(rootdir, group, dir, "pom.xml"))
        ]
