...
def generate_star_graph(ontologies, stats_path, timespan=6, interval=2):
    ...
    figure.add_trace(
        go.Scatter(
            ...
            name=string_tools.generate_star_string(4),
            stackgroup="one",
    ...
    figure.add_trace(
        go.Scatter(
            ...
            name=string_tools.generate_star_string(3),
            stackgroup="one",
    ...
    figure.add_trace(
        go.Scatter(
            ...
            name=string_tools.generate_star_string(2),
            stackgroup="one",
    ...
    figure.add_trace(
        go.Scatter(
            ...
            name=string_tools.generate_star_string(1),
            stackgroup="one",
    ...
    figure.add_trace(
        go.Scatter(
            ...
            name=string_tools.generate_star_string(0),
            stackgroup="one",
