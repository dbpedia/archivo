...
dev_log_path = "./logs/diff_dev.log"
...
dev_diff_logger = logging.getLogger("difflog_dev")
...
dev_diff_file_handler = logging.FileHandler(dev_log_path)

# set the base level of loggers
for logger in [webservice_logger, discovery_logger, diff_logger, dev_diff_logger]:
...
dev_diff_logger.addHandler(console_handler)
dev_diff_logger.addHandler(dev_diff_file_handler)
